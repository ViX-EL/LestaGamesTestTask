...
// выполняется алгоритм. Однимииз самых быстрых алгоритмов сортировки чисел
// являются: быстрая сортировка (Quick Sort), поразрядная сортировка
// (Radix Sort) и сортировка вставками (Insertion Sort). Insertion Sort
// (O(n^2)) справится лучше с небольшими массивами, чем Quick Sort, Quick Sort
// (O(n log n)) справится лучше с большими массивами, а Radix Sort (O(k * n))
// справится лучше с очень большими массивами.
